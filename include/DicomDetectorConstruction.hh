...
public:
    ...
    G4double GetVoxelMass(G4int,G4int,G4int) const;
    G4int GetNoVoxelsX() const {return fNVoxelX;}
    G4int GetNoVoxelsY() const {return fNVoxelY;}
    G4int GetNoVoxelsZ() const {return fNVoxelZ;}    
